 ...
 <?= form_open('/user/update') ?>
    ...
    <div class="bg-white border border-[rgba(37,63,114,0.25)] rounded-xl p-5 flex flex-col gap-3 mb-4">
         ...
         <div class="flex flex-col gap-1">
             ...
             <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none focus:border-[rgba(37,63,114,0.25)]" type="text" name="last_name" value="<?= $user['last_name'] ?>" required>
         ...
         <div class="flex flex-col gap-1">
             ...
             <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="first_name" value="<?= $user['first_name'] ?>" required>
         ...
         <div class="flex flex-col gap-1">
             ...
             <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="gender" value="<?= $user['gender'] ?>" required>
         ...
         <div class="flex flex-col gap-1">
             ...
             <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="email" name="email-signup" value="<?= $user['email']  ?>" required>
         ...
         <div class="flex flex-col gap-1">
             ...
             <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="address" value="<?= set_value('address') ?>" required>
         ...
         <div class="grid grid-cols-2 gap-3">
             <div class="flex flex-col gap-1">
                 ...
                 <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="postcode" value="<?= set_value('postcode') ?>">
             ...
             <div class="flex flex-col gap-1">
                 ...
                 <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="city" value="<?= set_value('city') ?>" required>
         ...
         <div class="grid grid-cols-2 gap-3">
             <div class="flex flex-col gap-1">
                 ...
                 <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="tel" name="mobile" value="<?= $user['mobile']  ?>">
             ...
             <div class="flex flex-col gap-1">
                 ...
                 <input class="w-full rounded-xl border border-[rgba(37,63,114,0.25)] px-3 py-2 text-xs text-bluegrey focus:outline-none" type="date" name="birth_date" value="<?= $user['birth_date'] ?>" required>
