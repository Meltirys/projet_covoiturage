<div class="grid grid-cols-1 md:grid-cols-2 gap-3">
    <div class="flex flex-col gap-1">
        ...
        <input type="text" id="brand" name="brand" value="<?= session()->getFlashdata('car_success') ? '' : old('brand') ?>"
    ...
    <div class="flex flex-col gap-1">
        ...
        <input type="text" id="model" name="model" value="<?= session()->getFlashdata('car_success') ? '' : old('model') ?>"
            class="w-full rounded-xl bg-ocean-light border border-ocean-light px-3 py-2 text-sm text-lightgrey focus:outline-none focus:border-babyblue">
    ...
    <div class="flex flex-col gap-1">
        ...
        <input type="text" id="color" name="color" value="<?= session()->getFlashdata('car_success') ? '' : old('color') ?>"
            class="w-full rounded-xl bg-ocean-light border border-ocean-light px-3 py-2 text-sm text-lightgrey focus:outline-none focus:border-babyblue">
    ...
    <div class="flex flex-col gap-1">
        ...
        <input type="text" id="year" name="year" value="<?= session()->getFlashdata('car_success') ? '' : old('year') ?>"
            class="w-full rounded-xl bg-ocean-light border border-ocean-light px-3 py-2 text-sm text-lightgrey focus:outline-none focus:border-babyblue">
    ...
    <div class="flex flex-col gap-1 md:col-span-2">
        ...
        <input type="number" id="places" name="places" value="<?= session()->getFlashdata('car_success') ? '' : old('places') ?>"
            class="w-full rounded-xl bg-ocean-light border border-ocean-light px-3 py-2 text-sm text-lightgrey focus:outline-none focus:border-babyblue">
