    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-6">
                ...
                <div class="mb-6">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <li class="flex justify-between items-center bg-white border border-[rgba(37,63,114,0.25)] rounded-xl px-4 py-3">
                            ...
                            <span class="text-xs font-poppins text-bluegrey bg-[#D6E0F0] rounded-full px-3 py-0.5">0</span>
                        </li>
                        <li class="flex justify-between items-center bg-white border border-[rgba(37,63,114,0.25)] rounded-xl px-4 py-3">
                            ...
                            <?php foreach ($cars as $car): ?>
                                <article class="flex justify-between items-center bg-white border border-[rgba(37,63,114,0.25)] rounded-xl px-4 py-3">
                                    ...
                                    <div class="flex gap-2">
                                        <button type="button" class="text-xs text-bluegrey border border-[rgba(37,63,114,0.25)] rounded-full px-3 py-1 hover:bg-[#D6E0F0] transition-colors duration-150">Modifier</button>
                    ...
                    <div id="add-car-form" style="display: <?= session()->getFlashdata('error_in_car_form') ? 'flex' : 'none' ?>" class="flex-col gap-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="text" id="brand" name="brand" value="<?= old('brand') ?>" class="border border-[rgba(37,63,114,0.25)] rounded-lg px-3 py-2 text-sm text-bluegrey focus:outline-none focus:border-bluegrey">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="text" id="model" name="model" value="<?= old('model') ?>" class="border border-[rgba(37,63,114,0.25)] rounded-lg px-3 py-2 text-sm text-bluegrey focus:outline-none focus:border-bluegrey">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="text" id="color" name="color" value="<?= old('color') ?>" class="border border-[rgba(37,63,114,0.25)] rounded-lg px-3 py-2 text-sm text-bluegrey focus:outline-none focus:border-bluegrey">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="text" id="year" name="year" value="<?= old('year') ?>" class="border border-[rgba(37,63,114,0.25)] rounded-lg px-3 py-2 text-sm text-bluegrey focus:outline-none focus:border-bluegrey">
                            ...
                            <div class="flex flex-col gap-1 md:col-span-2">
                                ...
                                <input type="number" id="places" name="places" value="<?= old('places') ?>" class="border border-[rgba(37,63,114,0.25)] rounded-lg px-3 py-2 text-sm text-bluegrey focus:outline-none focus:border-bluegrey">
                        ...
                        <div class="flex gap-2 mt-2">
                            ...
                            <button type="button" onclick="hideForm('add-car-form')" class="flex-1 border border-[rgba(37,63,114,0.25)] text-bluegrey rounded-xl py-2 text-sm hover:bg-[#D6E0F0] transition-colors duration-200">Annuler</button>
                        </div>
                        <?= form_close() ?>
                    </div>
                </div>
            ...
            <section class="flex flex-col md:flex-row-reverse gap-3 pb-6">
                ...
                <a href="/logout" class="w-full border border-[rgba(37,63,114,0.25)] text-bluegrey rounded-xl py-3 text-sm hover:bg-[#D6E0F0] transition-colors duration-200 text-center block">
                    Se déconnecter
                </a>
            </section>
