        ...
        <div class="flex flex-col gap-3 md:gap-0 md:items-end">
            <div class="flex justify-end">
                <button
                    ...
                    <span
                        id="toggle-thumb"
                        class="absolute pb-1 left-1 w-6 h-6 bg-white rounded-full transition-all duration-500 flex items-center justify-center text-sm shadow-md">
                        🚗
                    </span>
                </button>
            </div>
                        ...
                        <?php foreach ($cars as $car): ?>
                            <div id="car<?= $car['id_car'] ?>"
                                ...
                                <div class="flex items-center gap-3 min-w-0">
                                    <div class="w-10 h-10 rounded-xl bg-gold/10 border border-gold/15 flex items-center justify-center text-lg flex-shrink-0">🚗</div>
                                    <div class="min-w-0">
            ...
            <div class="bg-ocean-mid border border-ocean-light rounded-[14px] overflow-hidden mb-2">
                ...
                <a href="profil/modify"
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-[9px] bg-gold/10 border border-gold/15 flex items-center justify-center text-sm flex-shrink-0">👤</div>
                        <div>
                ...
                <a href="profil/changePassword"
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-[9px] bg-ocean-light border border-ocean-light flex items-center justify-center text-sm flex-shrink-0">🔑</div>
                        <div>
