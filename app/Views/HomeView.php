...
<main class="bg-lightgrey min-h-screen px-5 py-8 font-poppins">
    ...
    <?php if (!session('logged_in')) : ?>
        ...
        <div id="tab-login" class="auth-form-panel">
            ...
            <div class="bg-babyblue rounded-2xl border border-bluegrey p-5 flex flex-col gap-4 mb-4">
                <div class="auth-field flex flex-col gap-1">
                    <label class="auth-label text-xs font-medium tracking-widest text-bluegrey uppercase" for="email-auth">Email</label>
                    <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none auth-input" type="email" id="email-auth" name="email-auth" required>
                </div>
                <div class="auth-field flex flex-col gap-1">
                    <label class="auth-label text-xs font-medium tracking-widest text-bluegrey uppercase" for="password-auth">Mot de passe</label>
                    <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none auth-input" type="password" id="password-auth" name="password-auth" required>
                </div>
            ...
            <div id="tab-inscription" class="auth-form-panel <?= ($activeTab ?? 'login') === 'inscription' ? 'active' : '' ?>">
                ...
                <div class="bg-babyblue border border-bluegrey rounded-2xl p-5 flex flex-col gap-4">
                    <?= form_open('/signup') ?>

                    <div class="flex flex-col gap-1">
                        <label class="text-xs font-semibold tracking-widest text-bluegrey uppercase">Nom</label>
                        <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="last_name" value="<?= set_value('last_name') ?>" required>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="text" name="first_name" value="<?= set_value('first_name') ?>" required>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="email" name="email-signup" value="<?= set_value('email-signup') ?>" required>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="flex flex-col gap-1">
                            ...
                            <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="tel" name="phone" value="<?= set_value('phone') ?>">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="date" name="birth_date" value="<?= set_value('birth_date') ?>" required>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="password" name="password" required>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input class="w-full rounded-xl border border-bluegrey bg-lightblue px-3 py-2 text-xs text-bluegrey focus:outline-none" type="password" name="password_conf" required>
