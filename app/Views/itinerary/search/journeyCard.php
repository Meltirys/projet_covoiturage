<div class="flex flex-col gap-3 mt-6">
    <?php foreach ($journeys as $journey): ?>
        ...
        <a href="<?= base_url('drive/show/' . $journey['id_journey_drive']) ?>"
            class="block bg-ocean-mid border border-ocean-light rounded-[14px] px-5 py-4 hover-border-gold transition-colors">
            ...
            <div class="flex justify-end">
                <span class="bg-gold text-ocean font-semibold text-xs px-5 py-2 rounded-full">
                    Réserver
                </span>
            </div>
        </a>
